    ...
    <>
      ...
      {!open && (
        <button
          ...
          className="fixed bottom-[4.5rem] left-1/2 -translate-x-1/2 z-[45] w-10 h-10 rounded-full bg-violet-600 text-white shadow-lg flex items-center justify-center active:scale-95 transition-transform hover:bg-violet-700"
      ...
      {open && (
        <>
          ...
          <div className="fixed bottom-20 left-1/2 -translate-x-1/2 z-[101] w-[calc(100%-2rem)] max-w-[320px] bg-white rounded-2xl shadow-2xl overflow-hidden animate-slide-up">
            {/* Beta badge */}
