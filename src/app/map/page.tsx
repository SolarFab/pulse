...
export default function Home() {
  ...
  return (
    <div className="w-screen h-dvh bg-[#f2f0ea] md:flex md:items-center md:justify-center">
      {/* Desktop-only brand outside the phone frame — links back to the landing page */}
      <a href="/" className="hidden md:flex items-center gap-2 fixed top-5 left-6 z-10 select-none">
        <svg width="30" height="30" viewBox="0 0 64 64" aria-hidden="true">
          <defs>
            <linearGradient id="pulse-brand-g" x1="0" y1="0" x2="1" y2="1">
              <stop offset="0" stopColor="#8b5cf6" />
              <stop offset="1" stopColor="#e85d75" />
            </linearGradient>
          </defs>
          <rect x="2" y="2" width="60" height="60" rx="16" fill="url(#pulse-brand-g)" />
